...
export const heroIcons = [
  { id: 'icon-1', icon: <InstagramLineIcon /> },
  { id: 'icon-2', icon: <FacebookCircleLineIcon /> },
  { id: 'icon-3', icon: <DribbbleLineIcon /> },
  { id: 'icon-4', icon: <YoutubeLineIcon /> },
  { id: 'icon-5', icon: <GithubLineIcon /> },
]
